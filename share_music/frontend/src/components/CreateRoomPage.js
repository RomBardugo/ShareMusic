    ...
    handleRoomButtonPressed(){
        const requestOptions = {
            ...
            body: JSON.stringify({
                ...
                guset_can_pause: this.state.guestCanPause
            }),
        };
    ...
    render(){
        return (
            <Grid container spacing={1}>
                ...
                <Grid item xs={12} align="center">
                    <Button color="primary" veriant="containd" onClick={this.handleRoomButtonPressed}>Create A Room</Button>
                </Grid>
                <Grid item xs={12} align="center">
                    <Button color="secondary" veriant="containd" to="/" component={Link}>Back</Button>
                </Grid>
            </Grid>
        );
    }
